<?php /* Smarty version 2.6.28, created on 2014-01-03 03:37:12
         compiled from travel%5Cedit.phtml */ ?>
          ...
          <div id="line-map">
            <form id="travel-form" method="post">
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="title" id="title" placeholder="标题" value="<?php echo $this->_tpl_vars['art']['title']; ?>
">
              </div>
...
" <?php if ($this->_tpl_vars['map']['id'] == $this->_tpl_vars['art']['line_id']): ?>selected="selected"<?php endif; ?>><?php echo $this->_tpl_vars['map']['name']; ?>
</option>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="tags" id="tags" placeholder="标签" value="<?php echo $this->_tpl_vars['art']['tags']; ?>
">
              </div>
              <div class="form-group">
                ...
                <textarea class="form-control" name="descript" id="descript" placeholder="摘要" rows="4" style="display:none"><?php echo $this->_tpl_vars['art']['descript']; ?>
</textarea>
              </div>
            <div class="form-group">
